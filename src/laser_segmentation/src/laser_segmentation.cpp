  ...
  std::vector<slg::Segment2D> segment_list)
{
  ...
  viz_points.lifetime = rclcpp::Duration::from_seconds(0.1);;
  ...
  viz_centroids.lifetime = rclcpp::Duration::from_seconds(0.1);
  ...
  viz_text.lifetime = rclcpp::Duration::from_seconds(0.1);
  viz_text.ns = "id";
