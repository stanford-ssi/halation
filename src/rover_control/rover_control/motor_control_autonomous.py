...
class MotorControlAutonomous(Node):
    def __init__(self):
        super().__init__("motor_control_autonomous")
        ...
        self.waypoint_subscriber = self.create_subscription(
            String, "/next_waypoint", self.handle_vector, 10
        )
    ...
    def handle_vector(self, msg: String):
        ...
        # Clamp values to valid range, keeps the direction but prevents exceeding max speed
...
def main(args=None):
    ...
    motor_node = MotorControlAutonomous()
